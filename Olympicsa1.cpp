    ...
    while ((i < t1size1) || (j < t1size2) || (k < t1size3) || (l < t2size1) ||
        ...
        if ((j < t1size2) &&
            ...
            if(currentSmallest == team1STR2[j]->getKey()){
                ...
                currentSmallest = team1STR2[j]->getKey();
        ...
        if ((k < t1size3) &&
            ...
            if(currentSmallest == team1STR3[k]->getKey()){
                ...
                currentSmallest = team1STR3[k]->getKey();
        ...
        if ((l < t2size1) &&
            ...
            if(currentSmallest == team2STR1[l]->getKey()){
                ...
                currentSmallest = team2STR1[l]->getKey();
        ...
        if ((m < t2size2) &&
            ...
            if(currentSmallest == team2STR2[m]->getKey()){
                ...
                currentSmallest = team2STR2[m]->getKey();
        ...
        if ((n < t2size3) &&
            ...
            if(currentSmallest == team2STR3[n]->getKey()){
                ...
                currentSmallest = team2STR3[n]->getKey();
    ...
    try {
        ...
        while ((indexT1 < t1size1 + t1size2 + t1size3) || (indexT2 < t2size1 + t2size2 + t2size3)) {
            if ((indexT2 >= t2size1 + t2size2 + t2size3) || ((indexT1 < t1size1 + t1size2 + t1size3) &&
                                                             (team1ID[indexT1]->getKey()) <
                                                             (team2ID[indexT2]->getKey())))
                teamTotalID[currIndex++] = team1ID[indexT1++];
            else if ((indexT1 >= t1size1 + t1size2 + t1size3) || ((indexT2 < t2size1 + t2size2 + t2size3) &&
                                                                  (team1ID[indexT1]->getKey()) >
                                                                  (team2ID[indexT2]->getKey())))
